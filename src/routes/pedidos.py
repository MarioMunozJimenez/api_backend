...
def get_orders():
    ...
    return str(orders_list.to_json)
...
def get_delivery_orders():
    ...
    return str(delivery_orders_list.to_json)
...
def get_storage_orders():
    ...
    return str(storage_orders_list.to_json)
...
def get_delivered_orders():
    ...
    return str(delivered_orders_list.to_json)
